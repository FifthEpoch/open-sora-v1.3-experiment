# Configuration for text-to-video generation at 720p with maximum tile size
# Most aggressive tiling setting to minimize artifacts while using tiling
...
save_dir = "naive_experiment/results/t2v_720p_tile16"
...
# VAE configuration - MAXIMUM tile size (fewest tile boundaries)
vae = dict(
    ...
    tile_size=16,  # MAXIMUM - fewest artifacts, fastest processing
    normalization="video",

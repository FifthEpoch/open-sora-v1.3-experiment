# Configuration for text-to-video generation at 720p WITHOUT VAE tiling
# Option B: Disable tiling to eliminate rectangular artifacts
# NOTE: Requires significantly more memory (~200GB CPU RAM, ~100GB GPU VRAM)
...
save_dir = "naive_experiment/results/t2v_720p_notiling"
...
# VAE configuration - NO TILING for artifact-free decoding
vae = dict(
    ...
    # tile_size not used when tiling is disabled
    normalization="video",
